 ...
 */
public class SimpleRabbitMqConnectionFactoryUtil {
    ...
    public static ConnectionFactory getCachingConnectionFactory(RabbitProperties props, String scope) {
        ...
        com.rabbitmq.client.ConnectionFactory connectionFactory = SimpleRabbitMqConnectionFactoryUtil.getConnectionFactory(props);

        CachingConnectionFactory cachingConnectionFactory = new CachingConnectionFactory(connectionFactory);
        cachingConnectionFactory.setConnectionNameStrategy(cf -> {
            String name = SimpleRabbitMqHostNameUtil.HOSTNAME;
            if (name == null) {
                name = "SpringAMQP";
            }
